...
io.on('connection', function(socket){
    ...
    //Creo una chat tra i due utenti anche quando si è appena creata un'offerta
    socket.on("nuovaChat",function(msg) {
        socket.join(JSON.stringify(msg.id));
        console.log("[*] Join su offerta " + msg.id);
    });
